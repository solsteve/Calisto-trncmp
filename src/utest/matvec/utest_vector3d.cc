...
// =====================================================================================
bool check(Vector3D& V, real8_t* a ) {
  // -----------------------------------------------------------------------------------
  real8_t sum =
      ((V.x[0]-a[0])*(V.x[0]-a[0])) +
      ((V.x[1]-a[1])*(V.x[1]-a[1])) +
...
// =====================================================================================
TEST(test_construct_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
    Vector3D A;
    EXPECT_DOUBLE_EQ( 0.0, A.x[0] );
    EXPECT_DOUBLE_EQ( 0.0, A.x[1] );
    EXPECT_DOUBLE_EQ( 0.0, A.x[2] );
  }
...
TEST(test_set_vec3, Positive) {
...

  {
    ...
    EXPECT_DOUBLE_EQ( 7.2, A.x[2] );
  }
}


// =====================================================================================
TEST(test_copy_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
...
// =====================================================================================
TEST(test_access_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  Vector3D A;
  A[0] = 1.23;
  A[1] = 4.56;
...
// =====================================================================================
TEST(test_format_vec3, Positive) {
  // -----------------------------------------------------------------------------------
...
// =====================================================================================
TEST(test_unary_scale_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
    Vector3D A( 6.40, 1.28, 2.56 );
    A = 3.4;
...

  {
    ...
    EXPECT_DOUBLE_EQ( 1.28, A.x[2] );
  }
}


// =====================================================================================
TEST(test_unary_vector_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
    Vector3D A( 1.2, 3.4, 5.6 );
...
// =====================================================================================
TEST(test_binary_add_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
  ...
  
  {
    ...
    EXPECT_DOUBLE_EQ( 11.0, D.x[2] );
  } 
}


// =====================================================================================
TEST(test_binary_sub_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
    Vector3D A( 1.1, 2.2, 3.3 );
    Vector3D B( 1.2, 3.4, 5.6 );
  ...
  
  {
    ...
    EXPECT_DOUBLE_EQ(  6.8, D.x[2] );
  } 
}


// =====================================================================================
TEST(test_binary_mul_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
    Vector3D A( 1.1, 2.2, 3.3 );
    Vector3D B( 1.2, 3.4, 5.6 );
  ...
  
  {
    ...
    EXPECT_DOUBLE_EQ( 25.41, D.x[2] );
  } 
}


// =====================================================================================
TEST(test_binary_div_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
    Vector3D A( 1.1, 2.2, 3.3 );
  ...
  
  {
    ...
    EXPECT_DOUBLE_EQ( 6.5, D.x[2] );
  } 
}

// =====================================================================================
TEST(test_equals_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  {
...
// =====================================================================================
TEST(test_sum_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  Vector3D A( -1.2,  3.4, 2.7 );
  Vector3D B(  4.3, -1.1, 2.4 );

  EXPECT_DOUBLE_EQ(  4.90, sum(A) );
  EXPECT_DOUBLE_EQ( 20.29, sumsq(A) );
  EXPECT_DOUBLE_EQ( 50.59, sumsq(A,B) );    
}

// =====================================================================================
TEST(test_norm_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  Vector3D  A( -1.2,  3.4, -5.6 );
...
// =====================================================================================
TEST(test_dot_cross_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  Vector3D  A( -1.2,  3.4, -5.6 );
  ...
  EXPECT_DOUBLE_EQ( C.x[0], test.x[0] );
  EXPECT_DOUBLE_EQ( C.x[1], test.x[1] );
  EXPECT_DOUBLE_EQ( C.x[2], test.x[2] );
    
  EXPECT_DOUBLE_EQ( -66.10, dot( A, B ) );
}

// =====================================================================================
TEST(test_dist_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  Vector3D  A( -1.2,  3.4, -5.6 );
...
// =====================================================================================
TEST(test_swap_vec3, Positive) {
  // -----------------------------------------------------------------------------------
  real8_t adat[3] = {9.7, 9.3, 2.3};
  real8_t bdat[3] = {4.2, 5.3, 5.4};
