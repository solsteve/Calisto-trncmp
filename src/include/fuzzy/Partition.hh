 ...
 *
 * Provides the interface for a fuzzy partition.
 *
 *   NEG    SN  ZERO  SP    POS
 *  ____                    ____ 1
 *      \   /\   /\   /\   /
...
class Partition {
 ...
 public:
  ...
  void        write    ( std::ofstream& ps, std::string fmt = "%23.16e" );
  void        read     ( std::ifstream& scan );
